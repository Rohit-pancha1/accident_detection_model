...
def send_email_alert(alert):
    ...
    smtp_port = 587
    sender_email = 'rohit.panchal.9212@gmail.com'  # Update with your sender email
    receiver_email = 'prinshis673@gmail.com'  # Update with recipient email
    password = 'qteg ebxe zabb izpa'  # Update with your email password
